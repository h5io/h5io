...
def test_multi_dim_array():
    trajectory = [[[[0.001, 0.01, 0.02, 0.03],
                    [0.001, 0.11, 0.12, 0.13],
                    [0.001, 0.21, 0.22, 0.23],
                    [0.001, 0.31, 0.32, 0.33],
                    [0.001, 0.41, 0.42, 0.43]],
                   [[0.011, 0.01, 0.02, 0.03],
                    [0.011, 0.11, 0.12, 0.13],
                    [0.011, 0.21, 0.22, 0.23],
                    [0.011, 0.31, 0.32, 0.33],
                    [0.011, 0.41, 0.42, 0.43]],
                   [[0.021, 0.01, 0.02, 0.03],
                    [0.021, 0.11, 0.12, 0.13],
                    [0.021, 0.21, 0.22, 0.23],
                    [0.021, 0.31, 0.32, 0.33],
                    [0.021, 0.41, 0.42, 0.43]]],
                  [[[0.101, 0.01, 0.02, 0.03],
                    [0.101, 0.11, 0.12, 0.13],
                    [0.101, 0.21, 0.22, 0.23],
                    [0.101, 0.31, 0.32, 0.33],
                    [0.101, 0.41, 0.42, 0.43]],
                   [[0.111, 0.01, 0.02, 0.03],
                    [0.111, 0.11, 0.12, 0.13],
                    [0.111, 0.21, 0.22, 0.23],
                    [0.111, 0.31, 0.32, 0.33],
                    [0.111, 0.41, 0.42, 0.43]],
                   [[0.121, 0.01, 0.02, 0.03],
                    [0.121, 0.11, 0.12, 0.13],
                    [0.121, 0.21, 0.22, 0.23],
                    [0.121, 0.31, 0.32, 0.33],
                    [0.121, 0.41, 0.42, 0.43]],
                   [[0.131, 0.01, 0.02, 0.03],
                    [0.131, 0.11, 0.12, 0.13],
                    [0.131, 0.21, 0.22, 0.23],
                    [0.131, 0.31, 0.32, 0.33],
                    [0.131, 0.41, 0.42, 0.43]],
                   [[0.141, 0.01, 0.02, 0.03],
                    [0.141, 0.11, 0.12, 0.13],
                    [0.141, 0.21, 0.22, 0.23],
                    [0.141, 0.31, 0.32, 0.33],
                    [0.141, 0.41, 0.42, 0.43]]],
                  [[[0.201, 0.01, 0.02, 0.03],
                    [0.201, 0.11, 0.12, 0.13],
                    [0.201, 0.21, 0.22, 0.23],
                    [0.201, 0.31, 0.32, 0.33],
                    [0.201, 0.41, 0.42, 0.43]],
                   [[0.211, 0.01, 0.02, 0.03],
                    [0.211, 0.11, 0.12, 0.13],
                    [0.211, 0.21, 0.22, 0.23],
                    [0.211, 0.31, 0.32, 0.33],
                    [0.211, 0.41, 0.42, 0.43]],
                   [[0.221, 0.01, 0.02, 0.03],
                    [0.221, 0.11, 0.12, 0.13],
                    [0.221, 0.21, 0.22, 0.23],
                    [0.221, 0.31, 0.32, 0.33],
                    [0.221, 0.41, 0.42, 0.43]],
                   [[0.231, 0.01, 0.02, 0.03],
                    [0.231, 0.11, 0.12, 0.13],
                    [0.231, 0.21, 0.22, 0.23],
                    [0.231, 0.31, 0.32, 0.33],
                    [0.231, 0.41, 0.42, 0.43]]]]
    traj = np.array([np.array(t) for t in trajectory])
    tempdir = _TempDir()
    test_file = op.join(tempdir, 'test.hdf5')
